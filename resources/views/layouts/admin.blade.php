...
<head>
    ...
    <link href=" {{url('Admin/components/fontawesome-free/css/all.min.css')}} " rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

    <link href=" {{url('Admin/css/sb-admin-2.min.css')}} " rel="stylesheet">

    <link href=" {{url ('Admin/components/datatables/dataTables.bootstrap4.min.css')}}" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src=" {{url('Admin/components/jquery/jquery.min.js')}}"></script>
    <script src=" {{url('Admin/components/bootstrap/js/bootstrap.bundle.min.js')}} "></script>

    <!-- Core plugin JavaScript-->
    <script src=" {{url('Admin/components/jquery-easing/jquery.easing.min.js')}}"></script>

    <!-- Custom scripts for all pages-->
    <script src=" {{url('Admin/js/sb-admin-2.min.js')}}"></script>

    <!-- Page level plugins -->
    <script src=" {{url('Admin/components/chart.js/Chart.min.js')}}"></script>

    <!-- Page level plugins for table -->
    <script src=" {{url('Admin/components/datatables/jquery.dataTables.min.js')}} "></script>
    <script src=" {{url('Admin/components/datatables/dataTables.bootstrap4.min.js')}} "></script>
